const CONFIG = {
  ...
  HEO_NOTICE_BAR: [
    ...
    { title: 'NotesToNotion最强Notion知识库工具已上线', url: 'https://notes2notion.notionify.net' }
  ],
  ...
  HEO_HERO_TITLE_5: 'NotesToNotion0.1.11-小红书收藏自动同步到Notion',
  ...
  HEO_INFO_CARD_URL3: 'https://blog.notionedu.com',
  ...
  HEO_SOCIAL_CARD_URL: 'https://blog.notionedu.com',
